    ...
    <SsgoiTransition id="/slide-3">
      <SlideContainer isBackButton>
        ...
        <SlideHeader
          ...
          title={
            <>
              작업 요청 <span className="text-blue-400">발생</span>
            </>
          }
        ...
        <div className="flex-1 flex items-center justify-between px-[60px] pb-10 z-10">
          ...
          <div className="w-[45%] flex flex-col gap-8">
            ...
            {/* App Mockup */}
            <div className="bg-slate-800 rounded-xl border border-slate-700 overflow-hidden shadow-xl relative" data-hero-key="manager-app">
              ...
              <div className="absolute bottom-2 right-4 text-xs text-blue-300 font-mono">Event: button_click</div>
            </div>
            ...
            <div className="bg-slate-800 rounded-xl border border-slate-700 p-5 flex items-center gap-5 relative">
              ...
              <div className="absolute top-3 right-4 text-xs text-green-400 font-mono">Event: file_upload</div>
            </div>
          </div>
          ...
          <div className="w-[45%] flex flex-col gap-8">
            ...
            <div className="bg-slate-800 rounded-xl border-l-[6px] border-l-amber-500 p-6 relative overflow-hidden">
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="font-mono bg-black/30 py-1 px-2 rounded text-sm text-slate-300">job_type: resize</span>
              </div>
              <p className="text-slate-300 mb-2">이미지 크기 조절 작업</p>
              <ul className="text-sm text-slate-400 space-y-1">
                <li>
                  <i className="fas fa-check mr-2 text-yellow-500"></i>최적화된 해상도로 변환
                </li>
                <li>
                  <i className="fas fa-check mr-2 text-yellow-500"></i>1:1 비율의 원본 코너로지스 상품을 3:4 비율로 수정
                </li>
              </ul>
            </div>
            ...
            <div className="bg-slate-800 rounded-xl border-l-[6px] border-l-violet-500 p-6 relative overflow-hidden">
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="font-mono bg-black/30 py-1 px-2 rounded text-sm text-slate-300">job_type: create_ai</span>
              </div>
              <p className="text-slate-300 mb-2">AI 이미지 생성 작업</p>
              <ul className="text-sm text-slate-400 space-y-1">
                <li>
                  <i className="fas fa-check mr-2 text-purple-500"></i>코너로지스 원본 앞면 이미지를 기준으로 이미지 생성
                </li>
                <li>
                  <i className="fas fa-check mr-2 text-purple-500"></i>Flux (앞면 다림질) / Gemini (모델, 모델크롭샷) 모델 사용
                </li>
              </ul>
            </div>
          </div>
